...
from morgoth.auto_loc.time_selection import (
    TimeSelection,  # The classic
    TimeSelectionBB,  # The stupid
    TimeSelectionNew,  # The sophisticated stupid
)
...
class TimeSelectionHandler(luigi.Task):
    ...
    def run(self):
        ...
        if self.report_type == "trigdat":
            ...
            time_selection = TimeSelectionNew(
                grb_name=self.grb_name,
